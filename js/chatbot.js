...
Results-driven Senior Embedded & Firmware Engineer with 10+ years of expertise in embedded systems, IoT solutions, and low-level Linux development, including RTOS, device drivers, protocol stacks (IEC 60870, Modbus, MQTT), and cross-platform application development. Proven success in leading teams, delivering end-to-end product development, and integrating secure IoT devices. Open to global relocation and passionate about building smart, connected, and secure embedded systems.
Core Competencies
* Embedded Systems: Bare-metal, RTOS (FreeRTOS, TI-RTOS, Micrium), Embedded C/C++, DMA, low power high-speed design, ISR, interrupt-based programming, low latency systems, full product life cycle
* Linux & OS-Level: Yocto, Buildroot, Kernel Drivers, U-Boot, Multithreading, IPC
* AI/ML: Proficient in Google Colab, Jupyter notebook TensorFlow, tflite, Keras, TinyML, model training, dataset preprocessing, and deployment on edge devices. Worked with Image Object Detection, Image Classification, Speaker Recognition
...
* DevOps & Tools: Git, Jira, CI/CD, Unit Testing, Python, Selenium, Pytest, WinAppDriver, debug tools, Docker.
* UI/UX & Apps: Qt, wxWidgets, Android Studio, WPF, Windows Forms, Java, C#
* Hardware: STM32, PIC, BeagleBone, Raspberry Pi, PCB Design, Altium, Arduino, schematic design, ARM architectures, low-power hardware
* Security: TLS, secure boot, SHA cryptography, OTA firmware updates
* Cloud & Web: HTTPD, JSON/XML, Web Interfaces, Wireshark, IoT dashboards
* Automation: Built AI agents and implemented task automation pipelines leveraging the n8n platform.
